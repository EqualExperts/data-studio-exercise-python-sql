...
This exercise is based on Scala, although if you prefer Python there is a Python version [here](https://github.com/EqualExperts/data-studio-exercise-python-sql/tree/json-exercise).
